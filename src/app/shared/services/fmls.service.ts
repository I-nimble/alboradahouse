...
export class FmlsService {
  ...
  getByString(limit2, offset2, string){
    return this.httpClient.get<any>(`https://api.bridgedataoutput.com/api/v2/fmls/listings?permissionGroupID=21e09d51-f3ac-4909-b6aa-6be71af3bda0&and[0][MlsStatus][ne]=Canceled&and[1][MlsStatus][ne]=Closed&and[2][MlsStatus][ne]=Expired&and[3][MlsStatus][ne]=Withdrawn&limit=${limit2}&offset=0&sortBy[0]=BridgeModificationTimestamp&access_token=af4a076f5f40a608cb449aa8603422cc&City=${string}`).toPromise();
    // return this.httpClient.get<any>(`https://api.bridgedataoutput.com/api/v2/fmls/listings?access_token=af4a076f5f40a608cb449aa8603422cc&and[0][MlsStatus][ne]=Canceled&and[1][MlsStatus][ne]=Closed&and[2][MlsStatus][ne]=Expired&and[3][MlsStatus][ne]=Withdrawn&limit=${limit}&offset=0&City=${string}`).toPromise();
  }
  getByZip(limit2, offset2, string){
    return this.httpClient.get<any>(`https://api.bridgedataoutput.com/api/v2/fmls/listings?permissionGroupID=21e09d51-f3ac-4909-b6aa-6be71af3bda0&and[0][MlsStatus][ne]=Canceled&and[1][MlsStatus][ne]=Closed&and[2][MlsStatus][ne]=Expired&and[3][MlsStatus][ne]=Withdrawn&limit=${limit2}&offset=0&sortBy[0]=BridgeModificationTimestamp&access_token=af4a076f5f40a608cb449aa8603422cc&PostalCode=${string}`).toPromise();
  }
  cleanDataSearcher(data: any){
    const uniqueData = [];
    data.forEach(element => {
      this.dataArray ['id'] = element['ListingId'];
      this.dataArray ['title'] = element['BuildingName'];
      ...
      this.propertyN = new Property (this.dataArray['id'], 
                                    ...
                                    this.dataArray ['published'], 
                                    this.dataArray ['lastUpdated'], 0, this.dataArray['courtesy'])
      uniqueData.push(this.propertyN);
      // console.log('arraycleanData')
      // console.log(this.arrayCleanData)
    });
    return uniqueData;
